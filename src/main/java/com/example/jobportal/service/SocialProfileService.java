...
public class SocialProfileService {
	...
	public ResponseEntity<ResponseStructure<String>> updateSocialProfile(SocialProfileRequestDto socReq,int resumeId, int socialId) 
			throws ResumeNotFoundException, SocialProfileNotFoundException 
	...
	if (optResume.isPresent()) {
		...
		if (!socialList.isEmpty()) {
			...
			{
				SocialProfile updateProfile = convertToSocialProfile(socReq, sp);
