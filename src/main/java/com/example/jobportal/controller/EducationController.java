...
import com.example.jobportal.exceptionhandling.EducationNotFoundException;
...
public class EducationController {
	...
	public ResponseEntity<ResponseStructure<String>> inserEducation(@RequestBody @Valid EducationRequestDto eduReq,@PathVariable int resumeId 
			,@PathVariable EducationType eduType
