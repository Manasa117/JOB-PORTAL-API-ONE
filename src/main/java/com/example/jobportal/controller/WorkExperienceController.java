...
public class WorkExperienceController {
	...
	public ResponseEntity<ResponseStructure<List<WorkExperienceResponseDto>>> findWorkByResumeId(@PathVariable int resumeId ) 
			throws WorkExperienceFoundException, ResumeNotFoundException 
